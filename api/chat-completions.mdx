...
A successful request returns a JSON object matching the OpenAI chat completions schema. The `system_fingerprint` field is not included, in either non-streaming responses or streaming chunks.
