---
title: "GET /v1/balance — Check Your Kyara Credit Balance"
...
The balance endpoint returns your current credit balances, plan caps, and billing window details. Call it at any time to check how many credits you have remaining and when your base balance next refreshes.
...
<ResponseField name="balances" type="object">
  ...
  <Expandable title="Balances object">
    <ResponseField name="base" type="object">
      Credits from your plan's base allocation. Contains `credits` (integer) and `percent` (number — percentage of the base cap remaining).
    </ResponseField>
    ...
    <ResponseField name="total" type="object">
      Combined base and overage credits. Contains `credits` (integer) and `percent` (number — percentage of the total cap remaining).
    </ResponseField>
  </Expandable>
</ResponseField>
...
- **`500 server_error`** — the key is valid but Kyara encountered missing or invalid balance data.
