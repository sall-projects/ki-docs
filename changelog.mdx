...
<Update label="0.2" description="July 24, 2026" tags={["Stability", "Billing accuracy"]}>
  A large rewrite of the frontend plus a wave of gateway improvements. The whole stack is more stable, usage tracking is more precise, and caching hits far more often.
